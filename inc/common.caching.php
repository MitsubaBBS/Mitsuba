				...
				<div class="left-boxes">
					<div class="box-outer left-box" id="recent-images">
						<div class="box-inner">
							...
							<div class="boxcontent">';
		$recent_images = $conn->query("SELECT posts.*, boards.hidden FROM posts LEFT JOIN boards ON posts.board=boards.short WHERE boards.hidden=0 AND filename<>'' AND filename<>'deleted' AND filename NOT LIKE 'embed%' AND filename NOT LIKE 'spoiler%' ORDER BY date DESC LIMIT 0, 3;");
		...
		$file .= '<div class="right-boxes">
					<div class="box-outer right-box" id="recent-threads">
						<div class="box-inner">
							...
							<div class="boxcontent">';
		$recent_posts = $conn->query("SELECT posts.*, boards.hidden, boards.name AS bname FROM posts LEFT JOIN boards ON posts.board=boards.short WHERE boards.hidden=0 ORDER BY date DESC LIMIT 0, 15;");
