...
<a href="?/boards"><?php echo $lang['mod/no_big']; ?></a> <a href="?/boards/delete_yes&board=<?php echo $_GET['board']; ?>"><?php echo $lang['mod/yes_big']; ?></a><?php $mitsuba->admin->ui->endSection(); ?>
				<?php
		} else {
						?>
